...
INSERT INTO product_variants (variant_id, product_id, sku, variant_label, color_name, case_size_mm, storage_capacity_gb, ram_gb, connectivity, price, stock_quantity, weight_kg) VALUES
    ...
    (23, 1, 'IP15PM-512-BLTT', '512GB - Titan Xanh',     'Titan Xanh',     NULL, 512, NULL, NULL, 40990000, 10, 0.221),
    ...
    (24, 2, 'IP15-128-BLACK',  '128GB - Đen',             'Đen',           NULL, 128, NULL, NULL, 22990000, 28, 0.171),
    (25, 2, 'IP15-256-PINK',   '256GB - Hồng',            'Hồng',          NULL, 256, NULL, NULL, 25990000, 20, 0.171),
    ...
    (26, 3, 'MBA13-M3-256-MN', '8GB/256GB - Đêm',         'Đêm',           NULL, 256, 8,  NULL, 27990000, 13, 1.240),
    (27, 3, 'MBA13-M3-512-SL', '16GB/512GB - Bạc',        'Bạc',           NULL, 512, 16, NULL, 33990000, 7,  1.240),
    ...
    (28, 4, 'MBP14-M3P-512-SL', '18GB/512GB - Bạc',       'Bạc',           NULL, 512, 18, NULL, 52990000, 5, 1.550),
    (29, 4, 'MBP14-M3P-1TB-SG', '18GB/1TB - Xám Không Gian', 'Xám Không Gian', NULL, 1024, 18, NULL, 59990000, 3, 1.550),
    ...
    (30, 5, 'IPADAIR11-128-WIFI-SL', '128GB - Wi-Fi - Bạc', 'Bạc', NULL, 128, 8, 'WIFI', 16990000, 18, 0.462),
    (31, 5, 'IPADAIR11-128-CELL-BL', '128GB - Wi-Fi + Cellular - Xanh Dương', 'Xanh Dương', NULL, 128, 8, 'WIFI_CELLULAR', 19990000, 12, 0.470),
    (32, 5, 'IPADAIR11-128-CELL-SL', '128GB - Wi-Fi + Cellular - Bạc', 'Bạc', NULL, 128, 8, 'WIFI_CELLULAR', 19990000, 11, 0.470),
    (33, 5, 'IPADAIR11-256-WIFI-BL', '256GB - Wi-Fi - Xanh Dương', 'Xanh Dương', NULL, 256, 8, 'WIFI', 18990000, 14, 0.462),
    (34, 5, 'IPADAIR11-256-WIFI-SL', '256GB - Wi-Fi - Bạc', 'Bạc', NULL, 256, 8, 'WIFI', 18990000, 13, 0.462),
    (35, 5, 'IPADAIR11-256-CELL-BL', '256GB - Wi-Fi + Cellular - Xanh Dương', 'Xanh Dương', NULL, 256, 8, 'WIFI_CELLULAR', 21990000, 9, 0.470),
    ...
    (36, 7, 'AWS9-41-STAR', '41mm - Viền Nhôm Ánh Sao',  'Ánh Sao', 41, NULL, NULL, NULL, 10990000, 22, 0.038),
    (37, 7, 'AWS9-45-MID',  '45mm - Viền Nhôm Giữa Đêm', 'Giữa Đêm', 45, NULL, NULL, NULL, 11990000, 18, 0.039),
