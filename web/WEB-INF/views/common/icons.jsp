...
<svg style="display:none" aria-hidden="true">
  ...
  <%-- logo dùng trong header/footer (nền tối) - tô màu bằng CSS color trên thẻ <svg> bọc ngoài, khác với
       web/assets/images/logo-mark.svg (file tĩnh dùng làm favicon, tự có màu nền riêng) --%>
