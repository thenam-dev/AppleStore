        ...
        <section class="admin-main">
            ...
            <div class="admin-page-head">
                <div>
                    ...
                    <p>This first backend version manages product master data. Variant pricing and stock remain the next phase.</p>
                </div>
            ...
            <p class="admin-footer-note">Phase 1 covers product master data only. Variant/image/spec CRUD will be added on top of this skeleton.</p>
        </section>
    </main>
</body>
</html>
