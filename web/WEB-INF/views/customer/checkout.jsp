          ...
          <c:if test="${not empty defaultAddress}">
            <label class="pm-option addr-option"
              ...
              <span style="flex:1">
                ...
                <span class="tag" style="margin-left:6px">Mặc định</span>
...
<script>
  (function () {
    ...
    radios.forEach(function (radio) {
      radio.addEventListener('change', function () { applySelection(radio, true); });
    });

    var checkedRadio = document.querySelector('.addr-radio:checked');
    if (checkedRadio) { applySelection(checkedRadio, false); }
  })();
</script>
